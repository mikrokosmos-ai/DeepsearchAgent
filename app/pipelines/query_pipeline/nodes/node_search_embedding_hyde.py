# HyDE节点 (Hypothetical Document Embedding)
import sys
...
"""
  ...
  入参:  item_names / rewritten_query  (+ task_id 用于追踪)
  出参:  hyde_embedding_chunks
  步骤:
       1. 参数校验（item_names / rewritten_query）
       2. 让 LLM 生成假设性答案（HyDE Doc）
       3. 问题 + 假设答案拼接后向量化
       4. Milvus 混合检索（与普通向量路共用召回参数）
"""
